              ...
              <div class="col-md-12 text-center">
                <div class="lc-block mb-4">
                  <div editable="rich">
                    ...
                    <p>
                      The digital revolution has taken over, and while I may not
                      be local to you, I am definitely reachable. <br></br> Just
                      send me an email or a message on social media.
                    </p>
                    <p class="fs-3">
                      <a
                        ...
                        rel="noreferrer"
                      >
                        <i class="bi bi-envelope-plus fs-1"></i>
                      </a>
                      {" • "}
                      <a
